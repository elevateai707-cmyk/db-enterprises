...
export default function ServiceAreasSection() {
  // Split cities into two columns for layout
    ...
    <section className="bg-surface py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start max-w-5xl mx-auto">
          {/* Map Card */}
          <div className="aspect-[4/3] rounded-xl border border-border bg-background overflow-hidden relative">
            {/* Simplified Alberta/Calgary map */}
            <svg
              viewBox="0 0 400 300"
              className="w-full h-full"
              preserveAspectRatio="xMidYMid meet"
            >
              {/* Background map shape — stylized Alberta */}
              <path
